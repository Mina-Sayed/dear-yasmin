(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{canvas;ctx;width=0;height=0;constructor(e){if(this.canvas=document.getElementById(e),!this.canvas)throw Error(`Canvas not found`);let t=this.canvas.getContext(`2d`,{alpha:!0});if(!t)throw Error(`2D context not supported`);this.ctx=t,this.resize(),window.addEventListener(`resize`,()=>this.resize())}resize(){let e=Math.min(window.devicePixelRatio||1,2);this.width=window.innerWidth,this.height=window.innerHeight,this.canvas.width=this.width*e,this.canvas.height=this.height*e,this.canvas.style.width=`${this.width}px`,this.canvas.style.height=`${this.height}px`,this.ctx.scale(e,e)}clear(e=`rgba(0,0,0,0)`){this.ctx.fillStyle=e,e===`rgba(0,0,0,0)`||e===`transparent`?this.ctx.clearRect(0,0,this.width,this.height):this.ctx.fillRect(0,0,this.width,this.height)}drawHeart(e,t,n,r){this.ctx.fillStyle=r,this.ctx.beginPath();let i=n*.3;this.ctx.moveTo(e,t+i),this.ctx.bezierCurveTo(e,t,e-n/2,t,e-n/2,t+i),this.ctx.bezierCurveTo(e-n/2,t+(n+i)/2,e,t+(n+i)/2,e,t+n),this.ctx.bezierCurveTo(e,t+(n+i)/2,e+n/2,t+(n+i)/2,e+n/2,t+i),this.ctx.bezierCurveTo(e+n/2,t,e,t,e,t+i),this.ctx.fill(),this.ctx.closePath()}},t=class{keys={};joystick={x:0,y:0,active:!1};actionPressed=!1;keyboardActionPressed=!1;dragStart=null;touchId=null;actionTouchId=null;constructor(){this.startListening()}startListening(){window.addEventListener(`keydown`,e=>{this.keys[e.code]=!0,e.code===`Space`&&(this.keyboardActionPressed=!0)}),window.addEventListener(`keyup`,e=>{this.keys[e.code]=!1,e.code===`Space`&&(this.keyboardActionPressed=!1)}),document.body.addEventListener(`touchstart`,e=>{e.target.tagName===`CANVAS`&&e.preventDefault()},{passive:!1}),window.addEventListener(`touchstart`,e=>this.handleTouchStart(e),{passive:!1}),window.addEventListener(`touchmove`,e=>this.handleTouchMove(e),{passive:!1}),window.addEventListener(`touchend`,e=>this.handleTouchEnd(e))}handleTouchStart(e){for(let t=0;t<e.changedTouches.length;t++){let n=e.changedTouches[t],r=n.clientY>window.innerHeight*.4;r&&n.clientX<window.innerWidth/2?this.touchId===null&&(this.touchId=n.identifier,this.dragStart={x:n.clientX,y:n.clientY},this.joystick.active=!0):r&&this.actionTouchId===null&&(this.actionTouchId=n.identifier,this.actionPressed=!0)}}handleTouchMove(e){if(this.touchId!==null)for(let t=0;t<e.changedTouches.length;t++){let n=e.changedTouches[t];if(n.identifier===this.touchId&&this.dragStart){let e=n.clientX-this.dragStart.x,t=n.clientY-this.dragStart.y,r=Math.sqrt(e*e+t*t),i=Math.atan2(t,e);r>60&&(r=60),this.joystick.x=Math.cos(i)*(r/60),this.joystick.y=Math.sin(i)*(r/60)}}}handleTouchEnd(e){for(let t=0;t<e.changedTouches.length;t++){let n=e.changedTouches[t];n.identifier===this.touchId&&(this.touchId=null,this.dragStart=null,this.joystick={x:0,y:0,active:!1}),n.identifier===this.actionTouchId&&(this.actionTouchId=null,this.actionPressed=!1)}}isActionActive(){return this.actionPressed||this.keyboardActionPressed}getAxis(){if(this.joystick.active)return{...this.joystick};let e=0,t=0;if((this.keys.KeyW||this.keys.ArrowUp)&&--t,(this.keys.KeyS||this.keys.ArrowDown)&&(t+=1),(this.keys.KeyA||this.keys.ArrowLeft)&&--e,(this.keys.KeyD||this.keys.ArrowRight)&&(e+=1),e!==0||t!==0){let n=Math.sqrt(e*e+t*t);e/=n,t/=n}return{x:e,y:t}}},n=`LoveQuestStorage`,r=1,i=`assets`,a=`config`;const o=new class{db=null;objectUrls=new Map;getOrCreateObjectUrl(e,t){let n=this.objectUrls.get(e);if(n)return n;let r=URL.createObjectURL(t);return this.objectUrls.set(e,r),r}replaceObjectUrl(e,t){this.revokeObjectUrl(e);let n=URL.createObjectURL(t);return this.objectUrls.set(e,n),n}revokeObjectUrl(e){let t=this.objectUrls.get(e);t&&(URL.revokeObjectURL(t),this.objectUrls.delete(e))}async init(){return new Promise((e,t)=>{let o=indexedDB.open(n,r);o.onerror=()=>t(o.error),o.onsuccess=()=>{this.db=o.result,e()},o.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(i)||t.createObjectStore(i,{keyPath:`id`}),t.objectStoreNames.contains(a)||t.createObjectStore(a,{keyPath:`key`})}})}async saveAsset(e,t,n,r,a){if(!this.db)throw Error(`Storage not initialized`);let o={id:e,type:t,name:n,data:r,text:a,createdAt:Date.now()};return new Promise((t,n)=>{let a=this.db.transaction([i],`readwrite`).objectStore(i).put(o);a.onsuccess=()=>{let n=this.replaceObjectUrl(e,r);t({...o,url:n})},a.onerror=()=>n(a.error)})}async getAsset(e){if(!this.db)throw Error(`Storage not initialized`);return new Promise((t,n)=>{let r=this.db.transaction([i],`readonly`).objectStore(i).get(e);r.onsuccess=()=>{let e=r.result;if(e){let n=this.getOrCreateObjectUrl(e.id,e.data);t({...e,url:n})}else t(null)},r.onerror=()=>n(r.error)})}async getAllAssets(e){if(!this.db)throw Error(`Storage not initialized`);return new Promise((t,n)=>{let r=this.db.transaction([i],`readonly`).objectStore(i).getAll();r.onsuccess=()=>{let n=r.result.map(e=>{let t=this.getOrCreateObjectUrl(e.id,e.data);return{...e,url:t}});t(e?n.filter(t=>t.type===e):n)},r.onerror=()=>n(r.error)})}async updatePhotoText(e,t){if(!this.db)throw Error(`Storage not initialized`);return new Promise((n,r)=>{let a=this.db.transaction([i],`readwrite`).objectStore(i),o=a.get(e);o.onsuccess=()=>{let e=o.result;if(!e){r(Error(`Asset not found`));return}e.text=t;let i=a.put(e);i.onsuccess=()=>n(),i.onerror=()=>r(i.error)},o.onerror=()=>r(o.error)})}async deleteAsset(e){if(!this.db)throw Error(`Storage not initialized`);return new Promise((t,n)=>{let r=this.db.transaction([i],`readwrite`).objectStore(i).delete(e);r.onsuccess=()=>{this.revokeObjectUrl(e),t()},r.onerror=()=>n(r.error)})}async setConfig(e,t){if(!this.db)throw Error(`Storage not initialized`);return new Promise((n,r)=>{let i=this.db.transaction([a],`readwrite`).objectStore(a).put({key:e,value:t});i.onsuccess=()=>n(),i.onerror=()=>r(i.error)})}async getConfig(e){if(!this.db)throw Error(`Storage not initialized`);return new Promise((t,n)=>{let r=this.db.transaction([a],`readonly`).objectStore(a).get(e);r.onsuccess=()=>{let e=r.result;t(e?.value)},r.onerror=()=>n(r.error)})}cleanup(){this.objectUrls.forEach(e=>URL.revokeObjectURL(e)),this.objectUrls.clear()}};function s(e){let t=`/dear-yasmin/`;return`${t.endsWith(`/`)?t:`${t}/`}${e.replace(/^\/+/,``)}`}const c=[{id:1,text:`Our first date at the coffee shop ☕`,img:s(`assets/photos/p1.jpg`)},{id:2,text:`The trip to the beach 🌊`,img:s(`assets/photos/p2.jpg`)},{id:3,text:`Your graduation day 🎓`,img:s(`assets/photos/p3.jpg`)},{id:4,text:`That time we got lost hiking 🏔️`,img:s(`assets/photos/p4.jpg`)},{id:5,text:`Cooking dinner together 🍝`,img:s(`assets/photos/p5.jpg`)}],l={heroName:`Yasmin`,secretCode:`30924`,finalMessage:`Happy Anniversary my love! ❤️
Here's to many more adventures together.`,memories:[...c],level2StarsToWin:10,useCustomBGM:!1,customBGMUrl:null,async loadCustomContent(){try{await o.init();let e=await o.getAllAssets(`photo`);e.length>0?this.memories=e.map((e,t)=>({id:t+1,text:e.text||c[t]?.text||`Memory ${t+1} ❤️`,img:e.url})):this.memories=[...c];let t=await o.getConfig(`useCustomBGM`),n=await o.getAllAssets(`audio`);t&&n.length>0?(this.useCustomBGM=!0,this.customBGMUrl=n[0].url):(this.useCustomBGM=!1,this.customBGMUrl=null)}catch(e){console.error(`Failed to load custom content:`,e),this.memories=[...c]}},resetToDefaults(){this.memories=[...c],this.useCustomBGM=!1,this.customBGMUrl=null}};var u=class{ctx;bgm=null;constructor(){this.ctx=new(window.AudioContext||window.webkitAudioContext),this.setupBGM()}setupBGM(){this.bgm&&=(this.bgm.pause(),null);let e=l.useCustomBGM&&l.customBGMUrl?l.customBGMUrl:s(`assets/bgm.mp3`);this.bgm=new Audio(e),this.bgm.loop=!0,this.bgm.volume=.5}startBGM(){l.useCustomBGM&&this.bgm?.src!==l.customBGMUrl&&this.setupBGM(),this.bgm&&(this.bgm.currentTime=0,this.bgm.play().catch(e=>console.log(`Audio autoplay blocked until interaction`,e)))}resume(){this.ctx.state===`suspended`&&this.ctx.resume().catch(console.error)}playTone(e,t=`sine`,n=.1,r=.1){this.resume();let i=this.ctx.createOscillator(),a=this.ctx.createGain();i.frequency.setValueAtTime(e,this.ctx.currentTime),i.type=t,i.connect(a),a.connect(this.ctx.destination),i.start(),a.gain.setValueAtTime(r,this.ctx.currentTime),a.gain.exponentialRampToValueAtTime(1e-4,this.ctx.currentTime+n),i.stop(this.ctx.currentTime+n)}play(e){switch(e){case`collect`:this.playTone(880,`sine`,.1),setTimeout(()=>this.playTone(1760,`sine`,.2),50);break;case`click`:this.playTone(400,`triangle`,.05,.05);break;case`jump`:this.resume();let e=this.ctx.createOscillator(),t=this.ctx.createGain();e.frequency.setValueAtTime(150,this.ctx.currentTime),e.frequency.linearRampToValueAtTime(300,this.ctx.currentTime+.2),e.type=`square`,t.gain.setValueAtTime(.05,this.ctx.currentTime),t.gain.linearRampToValueAtTime(0,this.ctx.currentTime+.2),e.connect(t),t.connect(this.ctx.destination),e.start(),e.stop(this.ctx.currentTime+.2);break;case`win`:[523.25,659.25,783.99,1046.5].forEach((e,t)=>setTimeout(()=>this.playTone(e,`sine`,.5,.1),t*150));break;case`error`:this.playTone(150,`sawtooth`,.3,.1),setTimeout(()=>this.playTone(100,`sawtooth`,.3,.1),150);break}}},d=class{deltaTime=0;elapsedTime=0;lastTime=0;update(e){this.lastTime||=e,this.deltaTime=(e-this.lastTime)/1e3,this.deltaTime>.1&&(this.deltaTime=.1),this.elapsedTime+=this.deltaTime,this.lastTime=e}},f=class{currentState=null;renderer;input;audio;constructor(e,t,n){this.renderer=e,this.input=t,this.audio=n}changeState(e){this.currentState&&this.currentState.exit(),this.currentState=e;let t=e.constructor.name;console.log(`Entering State: ${t}`),this.currentState.enter()}update(e){this.currentState&&this.currentState.update(e)}draw(){this.currentState&&this.currentState.draw(this.renderer)}resize(e,t){this.currentState&&this.currentState.resize&&this.currentState.resize(e,t)}};function p(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var m=class{static showScreen(e){document.querySelectorAll(`.screen`).forEach(e=>e.classList.add(`hidden`));let t=document.getElementById(e);t&&(t.classList.remove(`hidden`),t.style.opacity=`1`)}static hideScreen(e){let t=document.getElementById(e);t&&t.classList.add(`hidden`)}static updateHUD(e){let t=document.getElementById(`hud-text`);t&&(t.innerText=e)}static showModal(e,t,n,r){let i=document.getElementById(`modal-overlay`);i||(i=document.createElement(`div`),i.id=`modal-overlay`,i.className=`modal-backdrop hidden`,document.body.appendChild(i)),i.innerHTML=`
            <div class="modal">
                <h2 style="color: var(--primary); margin: 0 0 12px 0;">${p(e)}</h2>
                <img src="${t}" class="img-frame" style="background:gray;" alt="Memory Photo">
                <p style="font-size: 1.1rem; line-height: 1.4; margin-bottom: 24px;">${p(n)}</p>
                <button id="modal-next">Continue ❤️</button>
            </div>
        `,i.classList.remove(`hidden`);let a=document.getElementById(`modal-next`);a&&(a.onclick=e=>{e.stopPropagation(),i.classList.add(`hidden`),r()})}},h=`modulepreload`,g=function(e){return`/dear-yasmin/`+e},_={};const v=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=g(t,n),t in _)return;_[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:h,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};var y=class{sm;hearts=[];constructor(e){this.sm=e}enter(){m.showScreen(`intro-screen`),this.hearts=[];for(let e=0;e<30;e++)this.hearts.push({x:Math.random()*window.innerWidth,y:Math.random()*window.innerHeight,s:10+Math.random()*30,spd:20+Math.random()*40,off:Math.random()*Math.PI*2});let e=document.getElementById(`start-btn`);e&&(e.onclick=()=>{this.sm.audio.play(`click`),this.sm.audio.startBGM(),v(async()=>{let{Level1State:e}=await import(`./level1-TawGN7gF.js`);return{Level1State:e}},[]).then(({Level1State:e})=>{this.sm.changeState(new e(this.sm))})});let t=document.getElementById(`admin-trigger`);t&&(t.onclick=()=>{this.sm.audio.play(`click`),v(async()=>{let{AdminState:e}=await import(`./admin-Q6jorBGP.js`);return{AdminState:e}},[]).then(({AdminState:e})=>{this.sm.changeState(new e(this.sm))})})}update(e){this.hearts.forEach(t=>{t.y-=t.spd*e,t.x+=Math.sin(Date.now()/1e3+t.off)*.5,t.y<-50&&(t.y=window.innerHeight+50,t.x=Math.random()*window.innerWidth)})}draw(e){e.clear(`#220510`),e.ctx.globalCompositeOperation=`screen`,this.hearts.forEach(t=>{let n=1+Math.sin(Date.now()/500+t.off)*.1;e.drawHeart(t.x,t.y,t.s*n,`rgba(255, 64, 129, 0.2)`)}),e.ctx.globalCompositeOperation=`source-over`}resize(e,t){this.hearts.forEach(e=>{e.x=Math.min(e.x,window.innerWidth),e.y=Math.min(e.y,window.innerHeight)})}exit(){m.hideScreen(`intro-screen`)}},b=`
<!-- Intro -->
    ...
    <div style="width: 100%; max-width: 600px; padding: 20px; display: flex; flex-direction: column; height: 100%; overflow-y: auto;">
        ...
        <div style="background: rgba(255,255,255,0.05); border-radius: 12px; padding: 16px; margin-bottom: 16px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                <h3 style="margin: 0; font-size: 1.1rem;">📸 Photos (${l.memories.length} default)</h3>
...
`,x=document.getElementById(`ui-layer`);x&&(x.innerHTML=b);try{let n=new e(`game-canvas`),r=new t,i=new u,a=new d,o=new f(n,r,i);window.addEventListener(`resize`,()=>{o.resize(n.width,n.height)}),l.loadCustomContent().then(()=>{console.log(`Custom content loaded:`,l.memories.length,`photos,`,l.useCustomBGM?`custom BGM`:`default BGM`),l.useCustomBGM&&i.setupBGM(),o.changeState(new y(o));let e=t=>{requestAnimationFrame(e),a.update(t);let n=Math.min(a.deltaTime,.05);o.update(n),o.draw()};requestAnimationFrame(e),console.log(`Game Initialized!`)})}catch(e){console.error(`Initialization Failed:`,e),document.body.innerHTML=`<h1 style="color:white; text-align:center; margin-top: 50px;">Sorry, something went wrong :(</h1><p style="color:#aaa; text-align:center;">${e}</p>`}export{o as a,l as i,v as n,m as r,y as t};